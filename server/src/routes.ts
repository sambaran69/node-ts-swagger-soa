...
const models: TsoaRoute.Models = {
    ...
    "Product": {
        "properties": {
            ...
            "features": { "dataType": "array", "array": { "ref": "ProdcutAttribute" } },
        },
    },
};
...
export function RegisterRoutes(app: express.Express) {
    app.get('/v1/Api',
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.getApi.apply(controller, validatedArgs as any);
    ...
    app.get('/v1/Products',
        function(request: any, response: any, next: any) {
            ...
            const controller = iocContainer.get<ProductsController>(ProductsController);
            if (typeof controller['setStatus'] === 'function') {
                (<any>controller).setStatus(undefined);
            }
